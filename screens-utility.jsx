...
const HelpScreen = ({ onBack, lang }) => {
  ...
  const faqs = [
    ...
    { q: "My listing expired, how do I relist?", a: "Go to Profile → My Listings → Expired tab → tap Relist. The form will be pre-filled and you can edit details before posting again." },
    { q: "How do I delete a listing?", a: "Profile → My Listings → tap the trash icon on any listing. Once deleted it cannot be restored." },
    { q: "Is this app free?", a: "Yes. AnnadathaBazar is free to use. We don't take a cut of any transaction — that happens directly between you and the buyer or seller." },
    { q: "How do I change my language?", a: "Settings → Language. We support 12 Indian languages including Hindi, Telugu, Kannada, Tamil and Marathi." },
    { q: "How do I report fake listings?", a: "Open the listing → tap the three-dot menu → Report. We review reports within 24 hours and remove fake listings." },
    { q: "How do I delete my account?", a: "Settings → Danger Zone → Delete Account. This permanently removes your profile and listings." },
  ];
...
Object.assign(window, { NotificationsScreen, SettingsScreen, HelpScreen });
