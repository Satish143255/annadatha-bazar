...
const TweaksUI = ({ tweaks, setTweak, onClose }) => (
  <TweaksPanel onClose={onClose} title="Tweaks">
    ...
    <TweakSection title="Language">
      <TweakSelect label="UI language" value={tweaks.lang} onChange={(v) => setTweak("lang", v)} options={[{ value:"en", label:"English" }, { value:"hi", label:"हिन्दी (Hindi)" }]} />
    </TweakSection>
